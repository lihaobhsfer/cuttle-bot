...
def display_options(
    prompt: str,
    current_input: str,
    pre_filtered_options: List[str],
    filtered_options: List[str],
    selected_idx: int,
    max_display: int,
    terminal_width: int,
    is_initial_display: bool = False,
) -> None:
    ...
    try:
        ...
        try:
            ...
            display_options(
                ...
                pre_filtered_options=pre_filtered_options,
                    ...
                    if ord(char) == 3:  # Ctrl+C
                        ...
                        if current_input:
                            ...
                            filtered_options = [
                                opt
                                for opt in options
                                if current_input.lower() in opt.lower()
                            ]
                            selected_idx = 0
                        ...
                        if next_char == "[":  # Arrow keys
                            ...
                            if key == "A":  # Up arrow
                                selected_idx = (
                                    (selected_idx - 1) % len(filtered_options)
                                    if filtered_options
                                    else 0
                                )
